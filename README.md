## velodyne (rolling) - 2.5.1-1

The packages in the `velodyne` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling velodyne` on `Thu, 31 Oct 2024 16:42:27 -0000`
...
## velodyne (jazzy) - 2.5.1-1

The packages in the `velodyne` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy velodyne` on `Thu, 31 Oct 2024 16:41:07 -0000`
...
## velodyne (iron) - 2.5.1-1

The packages in the `velodyne` repository were released into the `iron` distro by running `/usr/bin/bloom-release --track iron --rosdistro iron velodyne` on `Thu, 31 Oct 2024 16:39:34 -0000`
...
## velodyne (humble) - 2.5.1-1

The packages in the `velodyne` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble velodyne` on `Thu, 31 Oct 2024 16:38:20 -0000`
